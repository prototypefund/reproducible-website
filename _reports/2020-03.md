...
* [Opened #955298 in devscripts 2.20.2 by Holger Levsen (holger) «debrebuild: please switch from httpredir.d.o to deb.d.o».](https://bugs.debian.org/955298)
* [Opened #955304 in devscripts 2.20.2 by Holger Levsen (holger) «debrebuild: suggested sbuild command should use --no-run-lintian».](https://bugs.debian.org/955304)
* [Opened #955307 in devscripts 2.20.2 by Holger Levsen (holger) «debrebuild: should avoid downgrades».](https://bugs.debian.org/955307)
* [Opened #955308 in devscripts 2.20.2 by Holger Levsen (holger) «debrebuild: also explain *how* to use snapshot.d.o».](https://bugs.debian.org/955308)
