...
* **Upstream news & media coverage & upcoming events** — *Reproducing the Telegram messenger, etc.*
...
## Upstream news & media coverage & upcoming events
...
Vagrant Cascadian will present a talk at [SCALE](https://www.socallinuxexpo.org/) in Pasadena, California on March 8th titled [*There and Back Again, Reproducibly*](https://www.socallinuxexpo.org/scale/18x/presentations/there-and-back-again-reproducibly).
