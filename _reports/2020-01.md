...
... referencing an article by [Raymond Chen](https://devblogs.microsoft.com/oldnewthing/) from January 2018 which, amongst other things, mentions:
...
There was yet more progress towards making the [Debian Installer](https://www.debian.org/devel/debiah-installer/) images reproducible. Following-on from last months' efforts, Chris Lamb [requested a status update](https://bugs.debian.org/926242#157) on the [Debian bug in question](https://bugs.debian.org/926242#157).
