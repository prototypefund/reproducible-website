...
FIXME: provide links to bugs and maybe add this bit: the bug is not fixed yet, we work around by not using i386 kernels and thus loosing 32/64bit kernel variation testing...
