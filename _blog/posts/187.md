...
* Vagrant Cascadian automated uploading `.buildinfo` files from the Debian archive to the experimental [buildinfo.debian.net](https://buildinfo.debian.net/) service. At the time of this writing, over 200000 `.buildinfo` files have been uploaded from the Debian archive, typically uploading over 1000 additional `.buildinfo` files per day.
