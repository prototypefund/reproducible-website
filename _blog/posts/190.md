...
* We had an extremely rewarding and productive [Reproducible Builds summit](https://reproducible-builds.org/events/paris2018/) in Paris, France. Thank you to all who participated and helped organise the event.
    ...
    Also T-Shirts with the Reproducible-Builds.org logo were distrubuted at the event in Paris. If you are a contributor to Reproducible Builds and want a t-shirt, please send an email to Holger as [outlined in this mail](https://lists.reproducible-builds.org/pipermail/rb-general/2018-November/001266.html). The design is freely available in the [reproducible-promo-material git repo](https://salsa.debian.org/reproducible-builds/reproducible-promo-material/) in case you want to print some yourself.
