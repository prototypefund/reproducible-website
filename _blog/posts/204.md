...
* Mattia started to [set up](https://salsa.debian.org/reproducible-builds/rb-mailx-ansible) a new mail server (that will also serve )ur [mailing lists](https://lists.reproducible-builds.org)), to migrate out of our current hoster [potager.org](https://potager.org/).
